<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Ajouter une note</h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('notes.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="user_id" class="w-full border rounded px-3 py-2 @error('user_id') border-red-500 @enderror">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.5" min="0" max="20" name="note" value="{{ old('note') }}"
